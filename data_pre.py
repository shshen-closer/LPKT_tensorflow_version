...
print(all_data.head())
print(all_data['overlap_time'][:10])
...
#order = ['user_id','problem_id','correct','skill_id', 'start_time', 'end_time', 'answer_time', 'overlap_time']
#all_data1 = all_data[order]
#all_data1.to_csv('sss.csv')
...
print('lll')
print(len(user), len(problem), len(at))
